...
public class HelloSquare {
    ...
    private static void setUpVertexDataTriangle(int VAO, int VBO) {
    ...
    private static void setUpVertexDataRectangle(int VAO, int VBO, int EBO) {
        // Bind the VAO first to ensure any further modifications are stored correctly
        glBindVertexArray(VAO);
    ...
    public static void main(String[] args) {
        ...
        setUpVertexDataRectangle(VAO, VBO, EBO);
