...
public class ShaderClass {
    ...
    private static final URL VERTEX_SHADER_PATH = ShaderClass.class.getClassLoader().getResource("shader.vs");
    private static final URL FRAGMENT_SHADER_PATH = ShaderClass.class.getClassLoader().getResource("shader.fs");
