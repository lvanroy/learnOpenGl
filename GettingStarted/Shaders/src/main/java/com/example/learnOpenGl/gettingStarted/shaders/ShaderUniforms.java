...
public class ShaderUniforms {
    ...
    public static void main(String[] args) {
        ...
        while(!glfwWindowShouldClose(window)) {
            ...
            int colorVertexLocation = glGetUniformLocation(shaderProgram, "ourColor");

            // Use the shader program
            glUseProgram(shaderProgram);

            // Pass the selected color to the vector
            glUniform4f(colorVertexLocation, 0.0f, greenValue, 0.0f, 1.0f);
